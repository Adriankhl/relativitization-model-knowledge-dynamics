...
internal fun knowledgeDynamicsSingleRun(
    ...
    randomRandomNum: Int,
    randomPreferentialNum: Int,
    randomHomophilyNum: Int,
    randomDistanceNum: Int,
    transitiveRandomNum: Int,
    transitivePreferentialNum: Int,
    transitiveHomophilyNum: Int,
    transitiveDistanceNum: Int,
    sequentialRun: Int,
